...
Livelocks is similar to deadlock, as it is a state in which processes are not blocked, but are refrained from making progression. This can occur when processes are to busy responding to each other to resume work. 
...
The absence of starvation in concurrent algorithms is called liveness, which is a property guaranteeing all processes being able to make progress in finite time. 
